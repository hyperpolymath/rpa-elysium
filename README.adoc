...
= RPA Elysium
image:https://img.shields.io/badge/OpenSSF-Best_Practices-green?logo=openssourcesecurity[OpenSSF Best Practices,link="https://www.bestpractices.dev/en/projects/new?repo_url=https://github.com/hyperpolymath/rpa-elysium"]
...
Contributions welcome once implementation begins. See link:.github/CONTRIBUTING.md[CONTRIBUTING.md] for guidelines.
