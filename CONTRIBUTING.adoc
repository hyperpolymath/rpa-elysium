...
// Canonical contributing guide (estate policy: AsciiDoc at the repo root).
// The Markdown copy in .github/ is a pointer kept for GitHub's UI surfaces.
...
|*Rust*
|Core framework, WASM, CLI

|*ReScript*
|Management console UI

|*Gleam*
|Backend services (BEAM)

|*Deno*
|JS runtime (not Node.js)
