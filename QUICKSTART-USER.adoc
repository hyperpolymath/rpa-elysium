...
// Replace rpa-elysium, Rpa Elysium — See README.adoc for details., just run, Rpa Elysium started successfully. with actuals
= rpa-elysium — Quick Start for Users
:toc:
:toclevels: 2

== What is rpa-elysium?

Rpa Elysium — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./rpa-elysium-portable
----
...
[source]
----
Rpa Elysium started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/rpa-elysium/wiki
